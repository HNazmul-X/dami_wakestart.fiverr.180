                    ...
                    <div className="col-lg-6">
                        <div className="card large__card h-100 p-5 text-dark">
                            ...
                            <ul className="featured-list">
                                <li>Live text and alerts for trainer stocks/restocks</li>
                                <li>Live text and alerts for trainer stocks/restocks</li>
                                <li>Live text and alerts for trainer stocks/restocks</li>
                                <li>Live text and alerts for trainer stocks/restocks</li>
                                <li>Live text and alerts for trainer stocks/restocks</li>
                            ...
                            <button className="corner-budge btn bg-red text-light px-4">£30P/M</button>
                        </div>
                    </div>
                    <div className="col-lg-6">
                        <div className="">
                        ...
                        {[...new Array(2)].map((item) => (
                            <div className="col-lg-5 col-md-6 col-sm-8 mt-5">
                                <div className="card text-dark p-5 membership-small-card">
                                    ...
                                    <h3 className="text-center text-red price">£ 300.00 GBP.</h3>
